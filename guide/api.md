...
* `debug` - Enabled debug mode. See [debugging](./debugging.md) for details
...
### Examples
* [Simple window](../examples/open_url.md)
* [Multi-window](../examples/multiple_windows.md)
...
* [Open-file dialog](../examples/open_file_dialog.md)
* [Save-file dialog](../examples/save_file_dialog.md)
...
[Example](../examples/destroy_window.md)
...
[Example](../examples/get_current_url.md)
...
[Example](../examples/change_url.md)
...
[Example](../examples/window_title_change.md)
...
[Example](../examples/toggle_fullscreen.md)
